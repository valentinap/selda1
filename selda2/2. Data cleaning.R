...
stud$mark1[is.na(stud$mark1)] <- mean(stud$mark1, na.rm = TRUE)
stud$mark2[is.na(stud$mark2)] <- mean(stud$mark2, na.rm = TRUE)
stud$mark3[is.na(stud$mark3)] <- mean(stud$mark3, na.rm = TRUE)
...
rm.outlier(stud$mark2, fill = TRUE, median = TRUE, opposite = FALSE)

# per sostituire la variabile corretta nel dataset non dimentichiamo di sovrascrivere la variabile
stud$mark2 <- rm.outlier(stud$mark2, fill = TRUE, median = TRUE, opposite = FALSE)
