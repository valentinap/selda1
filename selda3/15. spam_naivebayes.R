...
spam <- read.table("/Users/valentinaporcu/R_test/smsspamcollection/SMSSpamCollection", 
                   quote = "", 
                   sep='\t',
                   row.names = NULL, 
...
# creaiamo la funzione che estragga i punteggi dell'ham
fun_ham <- function(x){
        y <- x[1,1]
        y
}
...
# creaiamo la funzione che estragga i punteggi dello spam
fun_spam <- function(x){
        y <- x[2,1]
        y
}
